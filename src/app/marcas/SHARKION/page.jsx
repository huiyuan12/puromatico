...
function SharkionPage() {
  return (
   <>
    <div>
      <div className='bg-custom-image-sharkion h-screen bg-center bg-no-repeat flex flex-col items-center'>

  
      <h1 className='text-center text-4xl font-bold text-white py-20'>Aspirador Robot Automático SHARK ION</h1>
    ...
    <div>
      <h2>Por qué elegir Shark ION</h2>
      <p>

      </p>
    </div>
    <main className='mt-20'>
      <h2 className='text-center text-2xl font-bold'>Los mejores Robot Aspiradores de SHARK ION </h2>
